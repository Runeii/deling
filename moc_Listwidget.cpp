...
struct qt_meta_stringdata_CLASSListWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSListWidgetENDCLASS = QtMocHelpers::stringData(
    "ListWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSListWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ListWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSListWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSListWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSListWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSListWidgetENDCLASS.stringdata0))
