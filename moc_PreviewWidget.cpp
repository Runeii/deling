...
struct qt_meta_stringdata_CLASSPreviewWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPreviewWidgetENDCLASS = QtMocHelpers::stringData(
    "PreviewWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPreviewWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PreviewWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPreviewWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPreviewWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPreviewWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *PreviewWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPreviewWidgetENDCLASS.stringdata0))
